    ...
    globalorderoffers !== undefined &&
      globalorderoffers.map(globalorderoffer => {
        discounts.push({
          ...
          //value: globalorderoffer.discountValue !== 0 ? globalorderoffer.discountValue : ''+ globalorderoffer.discountValue
          value: globalorderoffer.discountValue
        })
        discountoffers.push({
          label: globalorderoffer.offerName,
          value: globalorderoffer.offerName
        })
      })
    discounts.push({
      label: 'Enter Discount',
        ...
        <DismissKeyboard>
          <View style={styles.container_nocenterCnt}>
            ...
            <View style={[styles.paddingTopBtn20, styles.borderBottomLine]}>
              ...
              {discountoffers.map((discountoffer, ix) => (
                <View
                ...
                >
                  <Field
                    ...
                    customValue={discountoffer.value}
                    optionName={discountoffer.label}
                  />
                </View>
              ))}
            </View>
