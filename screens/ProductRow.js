...
import { Accordion, List, SwipeListView, SwipeRow, SwipeAction } from '@ant-design/react-native'
...
class ProductRow extends React.Component {
  ...
  PanelHeader = (labelName,labelId) => {
		return (
			<View style={{width: '100%', marginRight: 8, paddingTop: 15, paddingBottom: 15}}>
          ...
          <View style={styles.container}>
            ...
            <Accordion
            	onChange={this.onChange}
          		...
          		{
          		labels.map(lbl => 
          		<Accordion.Panel header={this.PanelHeader(lbl.label, lbl.id)} key={lbl.id}>               		
            		<List>  
            		{
